...
public class co extends Potion {
  ...
  public co(String paramString, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3) {
  ...
  public void a(TickEvent.PlayerTickEvent paramPlayerTickEvent) {
    ...
    ge.b.sendTo(new bd(entityPlayer), (EntityPlayerMP)entityPlayer);
  }
    ...
    if (paramLivingUpdateEvent.getEntity() instanceof EntityVillager) {
      ...
      try {
        if (entityVillager.func_70644_a(b)) {
          entityVillager.field_70714_bg.func_75776_a(2, new cw(entityVillager));
...
/* Location:              C:\Users\00773\Downloads\Fapcraft 1.12.2 v1.1.jar!\com\trolmastercard\sexmod\co.class
