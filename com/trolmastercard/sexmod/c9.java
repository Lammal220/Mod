...
public class c9 extends cv {
  ...
  public void a(em paramem, Integer paramInteger, AnimationEvent paramAnimationEvent) {
    ...
    //   26: astore #4
    //   28: aload_1
    //   29: invokevirtual h : ()Z
    //   32: ifne -> 130
    //   35: aload_1
    //   36: instanceof com/trolmastercard/sexmod/ff
    //   39: ifeq -> 130
    //   42: goto -> 49
    ...
    //   60: getstatic com/trolmastercard/sexmod/ff.aZ : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   103: aload_1
    //   104: checkcast com/trolmastercard/sexmod/ff
    //   107: getfield Q : Z
    //   110: ifne -> 121
    //   113: iconst_1
    //   114: goto -> 122
    ...
    //   156: aload_1
    //   157: invokestatic a : (Lcom/trolmastercard/sexmod/em;)[Ljava/lang/String;
    //   160: astore #5
    //   162: aload_0
    //   163: aload #4
    //   165: aload #5
    ...
    //   177: iconst_1
    //   178: aaload
    //   179: invokevirtual e : (Lsoftware/bernie/geckolib3/core/processor/AnimationProcessor;Ljava/lang/String;)V
    //   182: aload_0
    //   183: aload #4
    //   185: aload #5
    //   187: iconst_2
    ...
    //   260: iconst_4
    //   261: aaload
    //   262: invokevirtual a : (Lsoftware/bernie/geckolib3/core/processor/AnimationProcessor;Ljava/lang/String;)V
    //   265: aload_0
    //   266: aload #4
    //   268: aload #5
    //   270: iconst_5
    //   271: aaload
    //   272: invokevirtual d : (Lsoftware/bernie/geckolib3/core/processor/AnimationProcessor;Ljava/lang/String;)V
    //   275: aload_0
    //   276: aload_1
    //   277: aload #4
    //   279: aload #5
    //   281: bipush #6
    //   283: aaload
    //   284: invokevirtual a : (Lcom/trolmastercard/sexmod/em;Lsoftware/bernie/geckolib3/core/processor/AnimationProcessor;Ljava/lang/String;)V
    //   287: getstatic com/trolmastercard/sexmod/c9$a.a : [I
    //   290: aload_1
    //   291: invokevirtual y : ()Lcom/trolmastercard/sexmod/fp;
    ...
    //   362: aload_1
    //   363: aload #4
    //   365: invokevirtual b : (Lcom/trolmastercard/sexmod/em;Lsoftware/bernie/geckolib3/core/processor/AnimationProcessor;)V
    //   368: return
    // Exception table:
    //   from	to	target	type
  ...
  void b(em paramem, AnimationProcessor paramAnimationProcessor) {
    IBone iBone;
    try {
    ...
    float f = ((Float)paramem.func_184212_Q().func_187225_a(ff.aE)).floatValue();
    f = 0.25F - f;
  ...
  void a(em paramem, AnimationProcessor paramAnimationProcessor, String paramString) {
  ...
  void e(AnimationProcessor paramAnimationProcessor, String paramString) {
    List<IBone> list1 = c(paramAnimationProcessor, "hornDL");
    List<IBone> list2 = c(paramAnimationProcessor, "hornDR");
    a(list1);
    a(list2);
  ...
  void b(AnimationProcessor paramAnimationProcessor, String paramString) {
    List<IBone> list1 = c(paramAnimationProcessor, "hornUL");
    List<IBone> list2 = c(paramAnimationProcessor, "hornUR");
    a(list1);
    a(list2);
    int i = (new Integer(paramString)).intValue();
  ...
  List<IBone> c(AnimationProcessor paramAnimationProcessor, String paramString) {
  ...
  protected void a(em paramem, AnimationProcessor paramAnimationProcessor, AnimationEvent paramAnimationEvent) {
    ...
    try {
      switch (a.a[paramem.y().ordinal()]) {
        case 13:
          try {
            if (Math.abs(paramem.field_70169_q - paramem.field_70165_t) + Math.abs(paramem.field_70166_s - paramem.field_70161_v) < 0.0D)
              break; 
          } catch (RuntimeException runtimeException) {
            throw a(null);
          } 
          try {
            if (paramem.field_70122_E)
              try {
                if (Math.abs(Math.abs(paramem.field_70167_r) - Math.abs(paramem.field_70163_u)) > 0.10000000149011612D)
                  break; 
              } catch (RuntimeException runtimeException) {
                throw a(null);
              }  
...
/* Location:              C:\Users\00773\Downloads\Fapcraft 1.12.2 v1.1.jar!\com\trolmastercard\sexmod\c9.class
