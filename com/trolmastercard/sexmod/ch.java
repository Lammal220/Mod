...
public class ch extends GuiScreen {
  ...
  public ch(fo paramfo, EntityPlayer paramEntityPlayer) {
    this.c = paramfo;
    this.a = paramEntityPlayer;
    this.e = !"".equals(paramfo.func_184212_Q().func_187225_a(em.v));
  }
  ...
  public void func_73863_a(int paramInt1, int paramInt2, float paramFloat) {
    ...
    func_73729_b(i / 2 - 20, 20, ((Boolean)this.c.func_184212_Q().func_187225_a(fo.K)).booleanValue() ? 0 : 40, 130, 40, 40);
  }
  ...
  protected void func_73864_a(int paramInt1, int paramInt2, int paramInt3) throws IOException {
    ...
    int i = scaledResolution.func_78326_a();
    try {
      if (((Boolean)this.c.func_184212_Q().func_187225_a(fo.K)).booleanValue())
        try {
          if (paramInt1 >= i / 2 - 20)
            try {
              if (paramInt1 <= i / 2 + 20)
                try {
                  if (paramInt2 >= 20)
                    try {
                      if (paramInt2 <= 60) {
                        ge.b.sendToServer(new f3(this.c.f(), this.a.getPersistentID()));
                        func_146281_b();
                      } 
  ...
  protected void func_146284_a(GuiButton paramGuiButton) throws IOException {
    try {
      ...
      if (paramGuiButton.field_146127_k == 0) {
        try {
          if (this.e) {
            ge.b.sendToServer(new n(this.c.f(), "master", ""));
            this.a.func_145747_a((ITextComponent)new TextComponentString(I18n.func_135052_a("bee.dialogue.sad", new Object[0])));
          } else {
            ge.b.sendToServer(new n(this.c.f(), "master", this.a.getPersistentID().toString()));
            this.a.func_145747_a((ITextComponent)new TextComponentString(I18n.func_135052_a("bee.dialogue.exited", new Object[0])));
          } 
        } catch (IOException iOException) {
          throw a(null);
        } 
    ...
    try {
      if (paramGuiButton.field_146127_k == 1) {
        ge.b.sendToServer(new gg(this.c.f()));
        this.a.func_71053_j();
      } 
    } catch (IOException iOException) {
      throw a(null);
    ...
    try {
      if (paramGuiButton.field_146127_k == 2) {
        ge.b.sendToServer(new a6(this.c.f(), new Vec3d(this.c.field_70165_t, this.c.field_70163_u, this.c.field_70161_v)));
        this.a.func_71053_j();
        this.a.func_145747_a((ITextComponent)new TextComponentString(I18n.func_135052_a("bee.dialogue.home", new Object[0])));
      } 
    } catch (IOException iOException) {
      throw a(null);
    } 
...
/* Location:              C:\Users\00773\Downloads\Fapcraft 1.12.2 v1.1.jar!\com\trolmastercard\sexmod\ch.class
