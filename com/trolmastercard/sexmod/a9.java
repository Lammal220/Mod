...
public class a9 extends AnimatedGeoModel<ap> {
  ...
  public ResourceLocation b(ap paramap) {
    return new ResourceLocation("sexmod", "geo/allie/lamp.geo.json");
  }
  
  public ResourceLocation c(ap paramap) {
    try {
      if (this.a != null)
        return this.a; 
  ...
  public ResourceLocation a(ap paramap) {
...
/* Location:              C:\Users\00773\Downloads\Fapcraft 1.12.2 v1.1.jar!\com\trolmastercard\sexmod\a9.class
