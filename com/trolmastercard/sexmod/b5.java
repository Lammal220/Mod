...
public class b5 extends GuiScreen {
  ...
  public b5(HashMap<fy, String> paramHashMap) {
    for (fy fy : fy.values()) {
      try {
        if (!fy.isNpcOnly)
          try {
            Constructor<? extends em> constructor = fy.npcClass.getConstructor(new Class[] { World.class });
            em em = constructor.newInstance(new Object[] { this.field_146297_k.field_71441_e });
            em.b(true);
            this.a.add(em);
            String str = paramHashMap.get(fy);
            if (str != null)
              em.a(em.c(str)); 
  ...
  protected void func_146284_a(GuiButton paramGuiButton) {
    ...
    if (paramGuiButton.field_146127_k == 0) {
      ge.b.sendToServer(new b_(fy.a((Entity)this.a.get(this.b))));
...
/* Location:              C:\Users\00773\Downloads\Fapcraft 1.12.2 v1.1.jar!\com\trolmastercard\sexmod\b5.class
